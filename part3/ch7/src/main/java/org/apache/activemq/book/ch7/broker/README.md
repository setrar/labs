...
:round_pushpin: (as seen in ch:six: ) :eyes: when configuring ActiveMQ with security plug-ins using XML 
...
:round_pushpin: Let's Configure ActiveMQ with the same security plug-ins using Java
